...
def parseArguments():
    ...
    parser.add_argument("--api-key", help="CompreFace detection service API key", default='25001e1d-a476-4926-8bd3-e0bb0de34c99', type=str, required=True)
...
class ThreadedCamera:
    ...
    def show_frame(self):
        ...
        while self.capture.isOpened():
            ...
            cv2.imshow('CompreFace', self.frame)
            time.sleep(self.FPS)
